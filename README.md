...
An image gallery of slides that can be changed with left and right arrows.
...
This is day 18 of the '50 Projects In 50 Days' Udemy course by Brad Traversy and Florin Pop.
...
- Image gallery with a foreground and background image that can be switched through with left and right arrows.
